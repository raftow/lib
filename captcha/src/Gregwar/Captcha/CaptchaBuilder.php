    ...
    public function build($width = 150, $height = 40, $font = null, $fingerprint = null)
    {
        ...
        if (empty($this->backgroundImages)) {
            ...
            if ($this->backgroundColor == null) {
                ...
                $bg_red = $this->rand(200, 255);
                $bg_green = $this->rand(200, 255);
                $bg_blue = $this->rand(200, 255);
                $bg_source = "random = rgb($bg_red,$bg_green,$bg_blue)";
                $bg = imagecolorallocate($image, $bg_red, $bg_green, $bg_blue);
            } else {
