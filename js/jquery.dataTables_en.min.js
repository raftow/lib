...
oPaginate:{sFirst:"first",sLast:"last",sNext:"next",sPrevious:"previous"},sEmptyTable:"no records",sInfo:"showing  _START_ to _END_ from _TOTAL_ reord(s)",sInfoEmpty:"empty list of records",sInfoFiltered:"( filtered _MAX_ record(s))",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"show _MENU_ record(s)",sLoadingRecords:"loading...",sProcessing:"processing...",sSearch:"search of:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No record with these search criteria"},oSearch:h.extend({},
