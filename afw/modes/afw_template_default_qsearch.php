...
foreach ($class_db_structure as $nom_col => $desc) {
        ...
        if ($nom_col == "workflow_stage_id") die("rafik dbg 7/2/26 of workflow_stage_id : class_db_structure[$nom_col] = " . var_export($desc, true) . " is_settable_attribute = $is_settable_attribute");
