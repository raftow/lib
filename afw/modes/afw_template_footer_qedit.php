...
global $TMP_DIR, $TMP_ROOT, $cl, $pack, $sub_pack, $id, $aligntd, $first_disp, $first_val, $diff_val, $not_filled, $filled, $nb_objs,
    ...
    <div class='fright full-right-width'>
      ...
      if (!$popup) {
        ...
        if ($obj->id_origin and (!$obj->return_mode)) {
          if ($obj->mode_origin) $mode_origin = $obj->mode_origin;
          else $mode_origin = "display";
