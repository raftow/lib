...
$MODE_DEV = AfwSession::config("MODE_DEVELOPMENT", true);
...
<div class='logincontainer'>
        ...
        <div>
                ...
                <table cellspacing="8px" cellpadding="10px" class="grid" style="background-color: #efefef;border: 1px #000;border-style: solid;padding: 10px;">
                        ...
                        <tr>
                                ...
                                <td><?php echo AfwSession::config("site_administrator", "not defined") ?></td>
                        </tr>
                        <tr>
                                <th>تحويلة / Extension</th>
                                <td><?php echo AfwSession::config("site_administrator_extension", "not defined") ?></td>
                        </tr>
                        <tr>
                                <th>البريد الاكتروني/ Email</th>
                                <td><?php echo AfwSession::config("site_administrator_email", "not defined") ?></td>
                        </tr>
                        <tr>
        ...
        <?php
        if ($MODE_DEV or AfwSession::getSessionVar("user_golden")) {
        ?>
