...
function type_input($col_name, $desc, $obj, $selected = false)
{
    ...
    ?>
        ...
        case 'AMNT':
            ...
            ?> <input type="text" class="form-control <?= trim(" inputmoyenmoyen $class_inputSearch " . $inp_selected) ?>" name="<?php echo $col_name ?>" value="<? echo ((isset($_POST[$col_name])) ? $_POST[$col_name] : ''); ?>" size=32 maxlength="<?= $maxlength_input ?>">
        <?php echo $desc["UNIT"];
