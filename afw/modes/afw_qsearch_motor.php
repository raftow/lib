                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <script type="text/javascript">
                                                          $('#<?=$col_name?>').calendarsPicker({calendar: $.calendars.instance('UmmAlQura')});
                                                        </script>
                                                </td>
                                                <td style='padding:5px;'>
                                                        إلى
                                                ...
                                                <td>
                                                        ...
                                                        <script type="text/javascript">
                                                          $('#<?=$col_name."_2"?>').calendarsPicker({calendar: $.calendars.instance('UmmAlQura')});
                                                        </script>
                                                </td>
                                        </tr>
                                </table>
...
function type_oper($col_name, $desc,$obj, $selected=false)
{
	...
	{
		case 'PK'     :select(
					array(  "in (.)"     => $obj->translate('IN',$lang,true),
		...
		case 'DATE'   : select(
				...
				break;
		case 'TEXT'   : if($operSelected=="=") $operSelected = "like X'.'";
                                select(
					array(
...
function select($list_id_val, $selected = array(), $info = array(), $ordre = "", $null_val = true, $null_val_display="??? ????")
{
	...
	<script>
        ...
        <select
		onchange="<?php echo $info["name"] ?>_onchange()"
