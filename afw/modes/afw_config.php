...
$images =array(
    ...
    'modifier'		=> '../lib/images/square.png',    // modifier.png
...
$class_inputTextDate = "$class_inputText inputmoyenmoyen";
$class_inputDate = "$class_inputText inputmoyenmoyen inputdate";
