...
?>
        ...
        <div class="hzm_panel_link_bar header">
                ...
                ?>
                <input type="hidden" name="fixm_cols" value="<?php echo implode(",", $fixm_cols) ?>">
                <input type="hidden" name="fixm_vals" value="<?php echo implode(",", $fixm_vals) ?>">

                <table class="<?php echo $display_grid ?>" style="width: 100%;" cellspacing="3" cellpadding="4">
                        <thead>
                                <tr>
                                        ...
                                        ?>
                                                        <th <?php echo $class_xqe_prop ?> <?php echo $style ?> align="<?php echo $aligntd ?>"><?php echo $info ?><input type="hidden" name="<?php echo $col ?>_on" value="1"></th>
                                        <?php
                                                }
                                        }
