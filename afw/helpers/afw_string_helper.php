...
class AfwStringHelper
{
        ...
        public static function clean_input($string, $soft = true, $string_is_secure = false, $urldecode = false)
        {
                ...
                if (!$string_is_secure) {
                        ...
                        $string1 = str_replace('<script ', '', $string1);
                        $string1 = str_replace('<svg', '', $string1);
                        $string1 = str_replace('alert(', 'a l e r t', $string1);
                        $string1 = str_replace('</script>', '', $string1);
                        $string1 = str_replace('/script>', '', $string1);
                        $string1 = str_replace('java', 'j a v a', $string1);
                        $string1 = str_replace('script', 's c r i p t', $string1);
                        ...
                        if (!$soft) $string1 = preg_replace("/[`~^²¨%\"]/", '', $string1);

                        if (!$soft) $string1 = str_replace('(', '', $string1);
                        if (!$soft) $string1 = str_replace(')', '', $string1);
                }
                ...
                if ($string1 != $string3) {
                        ...
                        if (!$string_is_secure) $string2 = str_replace('<script ', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('<svg', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('alert(', 'a l e r t', $string2);
                        if (!$string_is_secure) $string2 = str_replace('</script>', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('/script>', '', $string2);
                        ...
                        if (!$string_is_secure) $string2 = str_replace('onchange', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('onclick', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('onerror', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('onmouseover', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('onmouseout', '', $string2);
                        if (!$string_is_secure) $string2 = str_replace('onkeydown', '', $string2);
