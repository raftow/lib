...
class AfwApiConsumeHelper
{
    ...
    private static function consume_complex_api(
        $bearer,
        $url,
        $token,
        $proxy = null,
    ...
    public static function consume_bearer_api(
        $url,
        $token,
        $proxy = null,
        $data = null,
    ...
    public static function consume_normal_api(
        $url,
        $proxy = null,
        $data = null,
        $verify_host = false,
    ...
    public static function runAPI($url, &$object, $params_attribute = "input", $lang = "ar")
    {
        ...
        if ($bearer_token) {
            ...
            $res = AfwApiConsumeHelper::consume_normal_api(
                $url,
                $proxy,
                $data,
                $verify_host,
