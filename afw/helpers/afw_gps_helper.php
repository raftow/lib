...
class AfwGpsHelper
{
	...
	public static function distance($lat1, $lon1, $lat2 = 24.651, $lon2 = 46.704, $alt1 = 0, $alt2 = 0)
	{
		// rayon de la terre
		$r = 6366;
		$lat1 = deg2rad($lat1);
	...
	public static function map($lat1, $lon1)
	{
		return "http://www.google.com/maps/place/$lat1,$lon1";
	}

	public static function route($lat1, $lon1, $lat2 = 24.651, $lon2 = 46.704)
	{
