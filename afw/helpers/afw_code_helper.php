    ...
    public static function generatePhpFile($module_code, $fileName, $php, $subFolder)
    {
        ...
        if ($php_generation_folder != "no-gen") {
            ...
            try {
                ...
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("info", "php file $fileName has been generated under $php_generation_folder \n");
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("info", "  to install the file :");
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("info", "  if the file is not new use your merge tool $merge_tool and do the following command to merge manually : ");
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("help", "  $merge_tool $generated_fileName $destination_fileName <br>\n");
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("info", "  if the file not do the following command line manually : ");
                $command_lines_arr[] = UfwUtils::hzm_format_command_line("help-mv", "  $mv_command$generated_fileName $root_module_path <br>\n");
