...
class AfwDateHelper
{
    ...
    public static function to_hijri(
        ...
        $hg_cache_file = dirname(__FILE__) . "/../../../lib/chsys/dates/greg_$greg_year" . "_to_hijri.php";
    ...
    private static function hijri_to_greg_from_files($original_hdate, $hijri_year = "")
    {
        ...
        $hijri_to_greg_file = dirname(__FILE__) . "/../../../lib/chsys/dates/hijri_" . $hijri_year . "_to_greg.php";
    ...
    public static function hijriDateTimeDiff(
        ...
        // $return = "[$hdate2 => $gdate2] - [$hdate1 => $gdate1] => $gdate2 $time2 - $gdate1 $time1 = $return";
