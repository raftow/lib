        ...
        if ($objme and ($objme instanceof Auser)) {
            ...
            if (!$application_id) {
                ...
                if (!$no_cache_use_for_ums) {
                    ...
                    /* if ($me_id == 1) {
                        die("CmsFrontMenu::loadUmsCacheForUser($me_id, $lang) = (
                        ...
                        user_info=$user_info,
                        user_cache_file_path=$user_cache_file_path) ");
                    }*/
                } else {
                    $cache_found = false;
                ...
                foreach ($menu_folders_arr as $menu_folder_id => $menu_folder_i) {
                    if (!$menu_folder_i and ($menu_folder_id !== '-1')) {
                        // skip empty menu ???!!!
                        ...
                        // if($menu_folder_id=="-1") die("html of menu($menu_folder_id) is ".$menu_folder_i_html);
