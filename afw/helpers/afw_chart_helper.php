...
class AfwChartHelper
{
    ...
    public static function modeChartInIFrame($url, $width='100%', $height='1200px')
    {
        $html = "<iframe src=\"$url\" style=\"float:right;padding:18px;border:none;width:$width; height:$height;\"></iframe>";
