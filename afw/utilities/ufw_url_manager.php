...
class UfwUrlManager extends AFWRoot
{
        ...
        if (true) {
            if ($direct_access == 'N') {
                if ($module_code and $object_table and $afw_action) {
                    ...
                    } else AfwSession::pushWarning("System need cache optimisation by creating previleges php file for module $module_code table $object_table <!-- file not found $module_sys_file -->");
