...
class UfwUtils
{
        ...
        {
                global $immediate_output, $immediate_output_nb;
                $id_html = UfwUtils::hzm_format_command_line($type, $objId, $lang);
                $title_html = UfwUtils::hzm_format_command_line($type, $objTitle, $lang);
                $errors_html = UfwUtils::hzm_format_command_line($error_class, $dataErrors, $lang);
        ...
        public static function hzm_attribute_command_line($type, $odd_oven, $name_att, $val_att, $lang, $name_class = "success")
        {
                ...
                $val_html = UfwUtils::hzm_format_command_line($type, $val_att, $lang);
                $name_html = UfwUtils::hzm_format_command_line($name_class, $name_att, $lang);
        ...
        public static function showUsingOldHzmTemplate($html_template_file, $data_tokens)
        {
                ob_start();
