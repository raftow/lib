...
class UfwNotificationManager extends AFWRoot {
                ...
                if($notification_type_settings["email"])
                {
                        ...
                        else
                        {
                                ...
                                else
                                {
                                        ...
                                        $res = UfwMailer::htmlSimpleMail($notification_code,"NOTIFY-BY-EMAIL-".$receiver["email"], $to_email_arr, $email_subject, $body_email, $lang);
