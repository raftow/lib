<?php
    class UfwBatch 
	{
        ...
        {
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "white")."\n";
        ...
        {
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($prefix_comment.$string, $foreground_color = "black", $background_color = "green")."\n";
            self::echo_batch($echo_text);
            return $echo_text; 
        }
        ...
        {
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "light_green")."\n";
            self::echo_batch($echo_text);
            return $echo_text; 
        }
        ...
        {
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "yellow")."\n";
            self::echo_batch($echo_text);
            return $echo_text; 
        }
        ...
        public static function print_error($string)
        {
            ...
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "white", $background_color = "red")."\n";
            self::echo_batch($echo_text);
            return $echo_text;
        }
        ...
        public static function print_warning($string)
        {
            ...
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "light_purple")."\n";
            self::echo_batch($echo_text);
            return $echo_text;
        }
        ...
        {
            // -- hzmc
            $echo_text = UfwBatchColors::getColoredString($string, $foreground_color = "white", $background_color = "blue")."\n";
            self::echo_batch($echo_text);
            return $echo_text;
        }
        ...
        public static function print_row($header,$row, $colors=null)
        {
            ...
            if($color_row) echo UfwBatchColors::getColoredString($row_text, $color_row, $bg_color_row)."\n";
            else echo $row_text."\n";
        }
        ...
        public static function html_row($header, $row, $colors=null)
        {
            ...
            if($color_row or $bg_color_row) $row_text = UfwBatchColors::getColoredHtml($row_text, $color_row, $bg_color_row);
        ...
        public static function emailError($project_code, $project, $error, $language="en", $dir="ltr")
        {
            ...
            if($email_errors)
            {
                    ...
                    $res = UfwMailer::hzmMail($project_code,"$project_code-error-$now_timestamp",$email_admin,$subject,$body, $send_from, $format="html", $language);
            }
            else
            {
                    $res = array();
