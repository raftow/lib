...
class AfwExcel
{
	...
	public static function genereExcel(
		$header_excel,
		$data_excel,
		$xls_page_title = 'نتائج البحث',
		$genereFileName = "",
		$addBigHeader = true,
		$returnLinkOrDownload = "link",
		$headerStyle = null,
		$bigHeaderStyle = null,
		$dataStyle = null,
		$data_align = "right",
		...
		*/
		...
		if ($genereFileName) {
			...
			$pure_link = "$upld_path/exports/$genereFileName.xlsx";
			if ($returnLinkOrDownload == "purelink") {
				$link = $pure_link;
				$returnLinkOrDownload = "link";
			} elseif ($returnLinkOrDownload == "link") {
				$link = "<center><div class='card'><br>تم تصدير ملف اكسل يحتوي على نتائج البحث  <br>
			<a href='$pure_link' class='btn btn-large btn-primary downloadlink'>تحميل الملف</a>		
			</div></center><br><br>";
			}
		}
