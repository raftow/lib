...
{
        CmsMainPage::addOutput("<b>Custom error:</b> [$errno] $errstr<br>");
        CmsMainPage::addOutput(" Error on line $errline in $errfile<br>");
}
...
include(dirname(__FILE__)."/../includes/afw_check_member.php");
