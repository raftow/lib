...
{
        $MODULE = "ums"; 
        require_once("$afw_dir_name/../../$MODULE/ini.php"); 
        require_once("$afw_dir_name/../../$MODULE/module_config.php"); 
...
if($correct_codeme==$codeme)
{
        ...
        require_once("$afw_dir_name/../../$MODULE/application_config.php");
        AfwSession::initConfig($config_arr, "system", "$afw_dir_name/../../$MODULE/application_config.php");
        ...
        // die("will include $afw_dir_name/../../$MODULE/main.php");
        
        include("$afw_dir_name/../../$MODULE/main.php");           
}
else
{
        include("$afw_dir_name/modes/afw_denied_access_page.php");
}           
?>