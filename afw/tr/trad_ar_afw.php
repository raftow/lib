...
class AfwOperatorArTranslator
{
    public static function initData()
    {
        ...
        $trad['OPERATOR']['EXCEL-DOWNLOAD'] = 'تحميل ملف الإكسيل';

        $trad['OPERATOR']['PDF-EXPORT'] = 'تصدير النتائج إلى ملف PDF وتحميله';
