...
if (!class_exists('AfwAutoLoader')) {
        ...
        class AfwAutoLoader extends AFWRoot
        {
                ...
                private static $modules_autoload_by_prio = [
                        '/',
                        '/../ums/',
                        '/../hrm/',
                ];  // "/../crm/","/../p-ag/", "/../b-au/",
                        ...
                        if (!class_exists($class, FALSE)) {
                                if ($class == 'AFWObject') {
                                        ...
                                        if (class_exists($class, FALSE))
                                                ...
                                                return array(true, "failed to find $class into $file_path_to_load", $failed_loadings_arr);
                                }

                                if (AfwStringHelper::stringStartsWith($class, 'AFW')) {
                                        $file_name = 'afw_' . AfwStringHelper::classToFile(substr($class, 3));
                                } else
                                        $file_name = AfwStringHelper::classToFile($class);
                                ...
                                return array(true, 'already exists', ['no need']);
                }
