...
?>      
  <li class="menu-small-item <?=$menu_color?>-item"><a href="#"><i class="fa fa-globe" aria-hidden="true"></i><?=AFWObject::traduireOperator("LANGUE", $lang)?></a>
     <ul>
     <?   
...
?>  
  <li class="menu-small-item <?=$menu_color?>-item"><a href="#"><i class="fa fa-cogs" aria-hidden="true"></i><?=AFWObject::traduireOperator("CONTROL", $lang)?></a>
     <ul>
          <li id="li_options">
          <a href="#"><i class="fa fa-cog info" aria-hidden="true"></i><?=AFWObject::traduireOperator("OPTIONS", $lang)?><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                <ul><!--ul-options-->
                <?
