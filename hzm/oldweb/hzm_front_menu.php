<?php
        ...
        if((is_object($objme)) and ($objme->id>0))
        {
                ...
                if(false)
                {
                        $html_hzm_menu .= "<li class=\"front-small-item front-$menu_color-item\"><a href=\"main.php?Main_Page=fm.php&m=control\"><i class=\"fa fa-cogs\"></i>".AfwLanguageHelper::translateKeyword("CONTROL", $lang)."</a></li>";
                }
