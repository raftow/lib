 ...
 * @var string $NOM_SYSTEM
 * @var string $html_hedear
 * @var string $system_date_format
 * @var string $file_cache
 ...
 * @var mixed $user_info
 * @var array $config
 * @var array $banner_height
 * @var array $title_app_height
 * @var array $logo_app_height
 * @var array $title_comp_height
 * @var array $logo_comp_height
 * @var array $std_banner 
 * @var array $scroll_banner
 * 
 * 
 *     
 * 
...
<body class="<?= $body_css_class ?>" dir="<?= $dir ?>">
        ...
        if ((!$no_front_header) and ($MODULE) and (!AfwSession::hasOption("FULL_SCREEN"))) {
                if (($system_date_format != "greg") and ($lang == "ar")) {
                        ...
                        list($wday, $display_date_day, $display_date_month, $display_date_year) = AfwDateHelper::currentGregDateArr();
                }
