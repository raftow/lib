...
oPaginate:{sFirst:"الأول",sLast:"الأخير",sNext:"تالي",sPrevious:"سابق"},sEmptyTable:"لا يوجد بيانات",sInfo:"بصدد إظهار  _START_ إلى _END_ من _TOTAL_ سجل(ات)",sInfoEmpty:"بصدد إظهار 0 إلى 0 من 0 سجلات",sInfoFiltered:"( مفلترة من مجموع _MAX_  سجل(ات))",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"إظهار _MENU_ سجلات",sLoadingRecords:"بصدد التحميل...",sProcessing:"بصدد الاجراء...",sSearch:"بحث عن كلمة:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا يوجد سجلات توافق معايير البحث"},oSearch:h.extend({},
